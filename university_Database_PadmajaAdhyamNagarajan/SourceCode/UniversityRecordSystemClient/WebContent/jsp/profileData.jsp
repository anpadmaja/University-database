	...
	if(getCookie("flag") == 'S')
	...
	else if(getCookie("flag") == 'I')
		{
			...
			$.ajax({
		        ...
		        success: function (msg) {
		        	var jsonObj = JSON.parse(msg);
		        	var dataArray = [ ['First Name', 'Last Name', 'address line', 'state', 'city','zip','emailId','departmentId', 'meetingHours', 'officeRoom', 'dateOfJoining', 'numberOfClasses','position' ] ];
					for ( var i = 0; i < 1; i++) {
						dataArray.push([ jsonObj.firstName,
						                 jsonObj.lastName,
						                 parseInt(jsonObj.addressLine),
										 ...
										 jsonObj.emailId,
										 parseInt(jsonObj.departmentId),
						                 jsonObj.meetingHours,
						                 jsonObj.officeRoom,
						                 jsonObj.dateOfJoining,
						                 parseInt(jsonObj.numberOfClasses),
						                 jsonObj.position
						                 ]);
					}
				 	for ( var i = 0; i < 1; i++) {
							$('#profileDataTable').append('<tr><td><b>Profile details</b></td></tr><tr><td id="firstName" style="width: 200px;padding-top: 30px;padding-left: 20px">First Name</td><td id="firstName">'+jsonObj.firstName
									...
									+'</td></tr><tr><td id="emailId" style="width: 200px;padding-top: 30px;padding-left: 20px">Email Id</td><td id="emailId">'+jsonObj.emailId
									+'</td></tr><tr><td id="departmentId" style="width: 200px;padding-top: 20px;padding-left: 20px">Department Id</td><td id="departmentId">'+jsonObj.departmentId
									+'</td></tr><tr><td id="meetingHours" style="width: 200px;padding-top: 20px;padding-left: 20px">Meeting Hours:</td><td id="admitSemester">'+jsonObj.meetingHours
									+'</td></tr><tr><td id="officeRoom" style="width: 200px;padding-top: 20px;padding-left: 20px">Office Room:</td><td id="currSemester">'+jsonObj.officeRoom
									+'</td></tr><tr><td id="dateOfJoining" style="width: 200px;padding-top: 20px;padding-left: 20px">Date Of Joining:</td><td id="degreePursuing">'+jsonObj.dateOfJoining
									+'</td></tr><tr><td id="numberOfClasses" style="width: 200px;padding-top: 20px;padding-left: 20px">Number of Classes:</td><td id="estimateGradutationYear">'+jsonObj.numberOfClasses
									+'</td></tr><tr><td id="position" style="width: 200px;padding-top: 20px;padding-left: 20px">Designation:</td><td id="gpa">'+jsonObj.position
									+'<br><tr><td><input type="button" id="editDetails" value="Change Data" onclick="editData();"></td></tr>');
