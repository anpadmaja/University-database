...
CREATE TABLE `charges` (
  `creditsCost` double DEFAULT NULL,
  `health service fee` double DEFAULT NULL,
  `association fee` double DEFAULT NULL,
...
INSERT INTO `charges` VALUES (2909,233,23,'123456790');
